                                ...
                                <ul class="sub-category">
                                    <li v-for="(category, key) in categories" :key="key">
                                        ...
                                        <ul class="inner-sub-category">
                                            <li v-for="(sub_category, key1) in category.sub_category" :key="key1">
    ...
    export default {
        ...
        methods:{
            logout()
            {
                ...
                var data = {token: this.customer.token}
                axios.post('http://127.0.0.1:8000/api/customer-logout', data).then((response) => {
